...
import nftIllstration from '@/assets/img/events/ethSignIllstration.svg';
import './index.scss';
        ...
        <div className={formatCN}>
          <div className="left">
            ...
            <div className="bannerContent">
              <h3 className="ct">SignX Program</h3>
              <div className="cn">
                <p>Building Trust in Trustless Systems</p>
